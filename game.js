            ...
            var j=0;
         	var EMPTY = 0,SNAKE = 1, FOOD=2,BOMB=3;
           ...
           function pause() {
         	...
         	var grid={
         		...
         		{  
  				...
  				{
  					this.griid[x][y]=val;   // put SNAKE or food value in position  in grid array  so grid array will have values 0 ->empty 1-> postion snake 2->fruit
         	...
         	var snake ={
         		...
         		insert: function(x,y)
         		{
         			this.queuee.unshift({x, y});    // append array  in beginning of array
         			this.last = this.queuee[0];
         		},

         		remove: function ()
         		{
         			return this.queuee.pop();      //get last element
         		}
         	...
         	{   j=Math.floor(Math.random()*img.length);
         		var empty= [];
         		for(var x=0;x<grid.width;x++)    // put food in  random empty cell in grid array
         		{
            ...
            sign = prompt("What's your name?");
             ...
             frames++;                //rate of changing between frames
         		...
         		if(frames%9===0){               // speed rate of snake
         			...
         			if(grid.get(nx,ny)===FOOD)   // if snake ate the FOOD
         			{
